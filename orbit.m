...
fprintf(' Earth Orbit\n')
fprintf(' %s\n', datestr(now))
fprintf('The initial position is [%g, %g, %g] (km).\n',r0(1), r0(2), r0(3))
fprintf('Magnitude = %g km\n', norm(r0))
fprintf('The initial velocity is [%g, %g, %g] (km/s).\n',v0(1), v0(2), v0(3))
fprintf('Magnitude = %g km/s\n', norm(v0))
fprintf('Initial time = %g h.\n Final time = %g h.\n',0,tf/hours)
fprintf('The minimum altitude is %g km at time = %g h.\n',rmin-R, t(imin)/hours)
fprintf('The speed at that point is %g km/s.\n', v_at_rmin)
fprintf('The maximum altitude is %g km at time = %g h.\n',rmax-R, t(imax)/hours)
fprintf('The speed at that point is %g km/s\n', v_at_rmax)
%...Plot the results:
% Draw the planet
[xx, yy, zz] = sphere(100);
